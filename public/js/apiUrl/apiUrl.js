window.XDPApi = 'http://dataset.hkstp.dev.curisinsight.com/v3';
...
window.DashboardWeb = 'http://enigma-dashboard.hkstp.dev.curisinsight.com/dashboard/builder';
...
window.DashboardApp = 'http://dashboardrunner-gateway.hkstp.dev.curisinsight.com/v3';
...
window.footerColumns = [{rows:[{type:'link',value:'沪ICP备16013332号',href:'http://www.miit.gov.cn/',style:{},},{type:'link',code:'terms.condition.translate',href:'https://xdp.basebit.me/home/privacy',"target":"_blank",style:{},},],style:{},},{rows:[{type:'text',value:'沪公网安备31010502003244号',style:{},},{type:'copyright',style:{},},],style:{},},];
...
window.powers = {user:{allowList:['email','mobile','firstName','lastName','company','position','verification',],actionList:{email:{label:'ticket.user.email',value:'',placeholder:'register.msg.email.required',type:'input',disabled:true,rules:[{required:true,code:'register.msg.email.required'}],},mobile:{label:'contact.phone',value:{region:'CN',mobile:''},placeholder:'enter.phone.number',type:'mobile',},firstName:{label:'firstName',value:'',placeholder:'enter.firstName',type:'input',rules:[{required:true,code:'enter.firstName'}],},lastName:{label:'lastName',value:'',placeholder:'enter.lastName',type:'input',rules:[{required:true,code:'enter.lastName'}],},company:{label:'org.company.school',value:'',placeholder:'enter.org.company.school',type:'input',disabled:true,},position:{label:'position',value:'',placeholder:'enter.position',type:'input',},verification:{label:'account.security',value:'0',options:[{title:'enable.email.verification',value:'1',},{title:'disable.email.verification',value:'0',},],type:'radio',},identificationType:{label:'user.identification.type',value:'',placeholder:'enter.user.identification.type',type:'input',},identificationNumber:{label:'user.identification.number',value:'',placeholder:'enter.user.identification.number',type:'input',},identificationExpiryDate:{label:'user.identification.expiried.date',value:null,placeholder:'enter.user.identification.expiried.date',type:'datepicker',},},},organization:{allowList:['name','country','city','email','description',],actionList:{name:{label:'org.or.company.name',value:'',placeholder:'enter.company.org.name',type:'input',rules:[{required:true,whitespace:true,code:'enter.company.org.name',},],},country:{label:'country.info',value:'',placeholder:'enter.country',type:'region',rules:[{required:true,code:'enter.country'}],},city:{label:'city.info',value:'',placeholder:'enter.city',type:'input',rules:[{required:true,whitespace:true,code:'enter.city',},],},email:{label:'ticket.user.email',value:'',placeholder:'please.enter.email',type:'input',rules:[{type:'email',code:'enter.correct.email'},{required:'true',code:'please.enter.email'},],},description:{label:'masterData.output.column.description',value:'',placeholder:'masterData.table.field.valid.desc',type:'textarea',},contactPersonName:{label:'contact.person.name',value:'',placeholder:'enter.contact.person.name',type:'input',},contactPersonPosition:{label:'contact.person.position',value:'',placeholder:'enter.contact.person.position',type:'input',},contactPersonEmail:{label:'contact.person.email',value:'',placeholder:'enter.contact.person.email',type:'input',},contactPersonPhone:{label:'contact.person.phone',value:{region:'CN',mobile:''},placeholder:'enter.contact.person.phone',type:'mobile',},agreementStatus:{label:'agreement.status',value:'',color:'',type:'badge',},attachments:{label:'supporting.documents',value:[],placeholder:'upload.files',type:'fileList',},status:{label:'status',value:'',color:'',type:'badge',},expiredAt:{label:'expired.date',value:null,type:'datepicker',disabled:true},},},};
window.redirectBlockList = ['fednodes'];
window.redirectBlockRouterList = ['/dataService/dataSource', '/dataService/datasets/' ,'/my/datasets/', '/projects/:id/data'];
